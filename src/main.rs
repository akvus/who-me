...
const HELP: &str = "who-me — identities, calendar, and mood statistics in your terminal
...
Press 1 for Identities, 2 for Calendar, 3 for Statistics, or g for GitHub sync.
";
